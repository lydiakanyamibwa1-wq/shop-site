...
const BestSellingProducts: React.FC = () => {
  ...
  return (
    <div className="bg-white p-10 rounded-xl shadow max-w-6xl mx-auto mb-5">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative ">
        {visibleProducts.map((product) => (
          <div
            key={product.id}
            className="border rounded-lg p-10 relative hover:shadow-md transition"
          >
            {/* Badge */}
