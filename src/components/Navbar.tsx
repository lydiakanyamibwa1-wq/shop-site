          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="relative">
                ...
                >
                  <span>ENGLISH</span>
                  <FaChevronDown className={`text-xs transition-transform ${languageDropdown ? 'rotate-180' : ''}`} />
                </button>
                
                {languageDropdown && (
                  <div className="absolute left-0 top-full mt-1 w-32 bg-white rounded shadow-lg border z-30">
                    <div className="py-1">
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">ENGLISH</button>
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">ESPAÑOL</button>
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">FRANÇAIS</button>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span>DOLLAR (US)</span>
                  <FaChevronDown className={`text-xs transition-transform ${currencyDropdown ? 'rotate-180' : ''}`} />
                </button>
                
                {currencyDropdown && (
                  <div className="absolute left-0 top-full mt-1 w-36 bg-white rounded shadow-lg border z-30">
                    <div className="py-1">
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">$ DOLLAR (US)</button>
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">€ EURO</button>
                      <button className="block px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left">£ POUND</button>
                    </div>
                  </div>
                )}
              </div>
